...
import ink.yowyob.business.book.infrastructure.repository.*;
...
import ink.yowyob.business.book.domain.service.impl.CommunicationWithOrganizationAPIImpl;
import ink.yowyob.business.book.domain.service.impl.ResearchServiceImpl;
import ink.yowyob.business.book.service.payload.request.LoginDto;
import ink.yowyob.business.book.service.payload.request.RegisterDto;
...
public class ResearchServiceTest {
    ...
    void setUp() {
        ...
        IntStream.range(1, 21).forEach(i -> {
            ...
            enterprise.setOrganizationId(GenerateUtils.generateId());
            ...
            //enterprise.setBusinessDomains(List.of(new Domain(GenerateUtils.generateId(), DomainName.LLC, "desc")));
            ...
            enterprise.setBusinessActorId(GenerateUtils.generateId());
            ...
            data.setEnterpriseId(GenerateUtils.generateId());
        ...
        mockedToken.setId(GenerateUtils.generateId());
        mockedToken.setContent(GenerateUtils.generateId().toString());
        mockedToken.setUserId(GenerateUtils.generateId());
